...
typedef enum {
    A_OP_MOV, A_OP_ADD, A_OP_SUB, A_OP_MUL, A_OP_DIV, A_OP_MOD, A_OP_EXP, A_OP_NEG, A_OP_INC, 
    A_OP_DEC, A_OP_AND, A_OP_OR, A_OP_XOR, A_OP_NOT, A_OP_SHL, A_OP_SHR, A_OP_CONCAT,
    A_OP_GETCHAR, A_OP_SETCHAR, A_OP_JMP, A_OP_JE, A_OP_JNE, A_OP_JG, A_OP_JL, A_OP_JGE,
    A_OP_JLE, A_OP_PUSH, A_OP_POP, A_OP_CALL, A_OP_RET, A_OP_CALLHOST, A_OP_PAUSE, A_OP_EXIT
} A_OpCode;
